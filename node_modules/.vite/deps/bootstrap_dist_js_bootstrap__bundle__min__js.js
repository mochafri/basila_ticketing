...
var require_bootstrap_bundle_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	(function(t, e) {
		...
		const rt = ".bs.carousel", at = ".data-api", lt = "ArrowLeft", ct = "ArrowRight", ht = "next", dt = "prev", ut = "left", ft = "right", pt = `slide${rt}`, mt = `slid${rt}`, gt = `keydown${rt}`, _t = `mouseenter${rt}`, bt = `mouseleave${rt}`, vt = `dragstart${rt}`, yt = `load${rt}${at}`, wt = `click${rt}${at}`, At = "carousel", Et = "active", Tt = ".active", Ct = ".carousel-item", Ot = ".active.carousel-item", xt = {
			[lt]: ft,
			[ct]: ut
		}, kt = {
			interval: 5e3,
		...
		class ps extends B {
			...
			_createPopper(t) {
				const i = ds[_(this._config.placement, [
					this,
					t,
					this._element
				]).toUpperCase()];
