<div class="d-flex gap-3 w-100">
    ...
    <div class="flex-grow-1">
        <?php if (!empty($taskStaff)): ?>
            <p class="m-0 fw-bold mb-2 custom-small-font">penugasan : staff terpilih</p>
            <div class="rounded-3 w-100 d-flex flex-column gap-3 shadow-md border p-2">
                <div class="d-flex gap-3 align-items-center p-3 rounded">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <span style="font-size: .7rem;" class="text-danger bg-danger bg-opacity-10 px-2 py-1 fw-bold text-center rounded"><?= esc(strtoupper($taskStaff['assign_task_to_staff'])) ?></span>
                    </div>
                </div>
